        ...
        <div className={`card-one-container backg-${data?.types[0].type.name}`}>
          <div>
            {isLoading ? (
              ...
              <img
                className={`shadow-${data?.types[0].type.name}`}
          ...
          <div className="stats-container-detail">
            ...
            <div className="stat-area">
              {data?.stats.map((stat) => (
                <span
                  key={stat.stat.name}
                  className={`stat-bar stat-bar-${stat.base_stat}`}
                >
                  {stat.base_stat}
                </span>
              ))}
